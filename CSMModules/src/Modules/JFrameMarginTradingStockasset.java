...
/*
 * JFrameMarginTradingStockasset.java
 *
 * Created on 2013-7-1, 16:39:33
 */
 ...
 */
public class JFrameMarginTradingStockasset extends javax.swing.JFrame {
    Vector service_person_id = new Vector();
    Vector columnType = new Vector();
    boolean addSerial = true;
    /** Creates new form JFrameMarginTradingStockasset */
    public JFrameMarginTradingStockasset() {
         initComponents();
        int iThisWidth = 1010;
        int iThisHight = 516;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jComboBoxServicePerson, 0, 211, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "execute get_margin_trading_client_stockasset ";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String stock_code = jTextFieldStockCode.getText().trim();
        String sql = "execute get_margin_trading_stockasset ";
        if (stock_code.equals("")) {
