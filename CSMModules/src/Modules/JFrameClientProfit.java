...
/*
 * JFrameClientProfit.java
 *
 * Created on 2011-3-8, 17:59:04
 */
package Modules;
 ...
 */
public class JFrameClientProfit extends javax.swing.JFrame {

    Vector service_person_id = new Vector();
    Vector columnType = new Vector();
    boolean addSerial = true;

    /** Creates new form JFrameClientProfit */
    public JFrameClientProfit() {
        initComponents();
        int iThisWidth = 1010;
        int iThisHight = 744;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("客户买卖盈亏情况");

        jLabel2.setText("客户买卖盈亏明细");

        jLabel3.setText("客户资产增值历史");

        jLabel4.setText("客户当前持股浮动盈亏");

        jLabel5.setText("资金帐号");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextFieldFundAccount, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(66, 66, 66)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String end_year_month = getEndYearMonth();
        ...
        sql = "get_client_stock_asset  " + user_id + "," + WholeAccount;
        System.out.println(sql);
        dm3.fetchDataToTable(Main.conn, sql, columnType, addSerial);

        JDBTableModel dm4 = new JDBTableModel(jTable4);
        sql = "get_asset_increment  " + WholeAccount + ",'" + end_year_month + "'," + user_id;
        System.out.println(sql);
    ...
    String getEndYearMonth() {
        ...
        System.out.println("end_year_month="+ endYearMonth);
        return endYearMonth;
    }
