 ...
 */
public class JFrameReport1 extends javax.swing.JFrame {

    Vector columnType = new Vector();
    boolean addSerial = false;

    /** Creates new form JFrameReport1 */
    public JFrameReport1() {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String outputFile = "客户佣金分布统计" + getDateString() + ".xls";
        ...
        try {
            ...
            Logger.getLogger(JFrameReport1.class.getName()).log(Level.SEVERE, null, ex);
