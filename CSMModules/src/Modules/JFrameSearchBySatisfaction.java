...
/*
 * JFrameSearchBySatisfaction.java
 *
 * Created on 2010-4-30, 18:09:09
 */
package Modules;
 ...
 */
public class JFrameSearchBySatisfaction extends javax.swing.JFrame {

    /** Creates new form JFrameSearchBySatisfaction */
    public JFrameSearchBySatisfaction() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(36, 36, 36)
                .addComponent(jComboBoxSatisfaction, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(90, 90, 90)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String satisfactionSelected = jComboBoxSatisfaction.getSelectedItem().toString();
        String sql = "execute get_client_info4_1 ";
        sql = sql + user_id + ",'" + satisfactionSelected + "'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int user_id = JFrameLogin.user_id;
        String satisfactionSelected = jComboBoxSatisfaction.getSelectedItem().toString();
        String sql = "execute get_client_info4 ";
        sql = sql + user_id + ",'" + satisfactionSelected + "'";
        System.out.println(sql);
        JDBTableModel dm = new JDBTableModel(jTable1);
        Vector columnType = new Vector();
