...
/*
 * JFrameClientByTel.java
 *
 * Created on 2012-6-19, 14:49:44
 */
package Modules;
 ...
 */
public class JFrameClientByTel extends javax.swing.JFrame {

    /** Creates new form JFrameClientByTel */
    public JFrameClientByTel() {
        initComponents();
        int iThisWidth = 1000;
        int iThisHight = 220;
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(58, 58, 58)
                        .addComponent(jTextFieldTel, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(102, 102, 102)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String telephone = jTextFieldTel.getText().trim();
        String sql = "execute get_client_by_tel " + user_id + ",'" + telephone + "'";
