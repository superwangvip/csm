...
public class PieChartServicePersonAsset {
    JFreeChart chart = null;
    Vector itemData = null;

    public void createPieChart(Vector data) {
        itemData = data;
        JFreeChart pieChart = ChartFactory.createPieChart("服务员-客户资产占比图",
...
//得到饼图的Plot对象
        ...
        //将饼图显示在图像界面上
        ChartFrame frame = new ChartFrame("服务员-客户资产占比图", pieChart);
        frame.pack();
        int iThisWidth = 800;
        int iThisHight = 560;
