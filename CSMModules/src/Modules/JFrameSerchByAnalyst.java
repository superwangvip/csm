...
/*
 * JFrameSerchByAnalyst.java
 *
 * Created on 2010-11-25, 17:28:15
 */
package Modules;
 ...
 */
public class JFrameSerchByAnalyst extends javax.swing.JFrame {

    Vector columnType = new Vector();
    boolean addSerial = true;

    /** Creates new form JFrameSerchByAnalyst */
    public JFrameSerchByAnalyst() {
        initComponents();
        int iThisWidth = 1000;
        int iThisHight = 700;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("点击统计表记录可列出客户清单");

        jLabel2.setText("分析师指定服务客户统计表");

        jLabel3.setText("分析师指定服务的客户清单");
