...
public class PieChartBuySellProfit {
    ...
    public void createPieChart(Vector data) {
        itemData = data;
        JFreeChart pieChart = ChartFactory.createPieChart3D("买卖盈亏分布图(收益率±1%以内视为保本)",
...
//得到饼图的Plot对象
        ...
        //将饼图显示在图像界面上
        ChartFrame frame = new ChartFrame("买卖盈亏分布", pieChart);
        frame.pack();
        int iThisWidth = 800;
        int iThisHight = 560;
