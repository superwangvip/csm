...
public class MarketPostionRatioCurve extends JFrame {

    Vector dataSet = new Vector();

    public MarketPostionRatioCurve(String s, Vector dataSet) {
        super(s);
        ...
        System.out.println("month=" + month + ",zoom=" + zoom);
        chartpanel.setPreferredSize(new Dimension((int) (1000 * zoom), 500));
    ...
    private static JFreeChart createChart(XYDataset xydataset) {
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("市占率曲线(成交量占有率‰)", "年月", "‰", xydataset, true, true, false);
    ...
    private XYDataset createDataset() {
        TimeSeries timeseries1 = new TimeSeries("单月市占率", org.jfree.data.time.Month.class);
        TimeSeries timeseries2 = new TimeSeries("累计市占率", org.jfree.data.time.Month.class);
